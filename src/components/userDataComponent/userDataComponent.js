...
export const UserDataComponent = (props) => {
  ...
  const currentSelectedUserData = useState({
    id: 2,
    first_name: "d",
    last_name: "sdf",
    userimage: "",
  ...
  const [detailsSectionClass, setDetailsSectionClass] = useState(
  ...
  const toggleUserInfoDetailsSection = () => {
    ...
    setDetailsSectionClass(
      detailsSectionClass === "card-user-info-section"
        ...
        <div>
          ...
          <div className="card-section">
            <div className="card-avatar-section">
              ...
              <img
                src={currentSelectedUserData.userimage}
                className="card-user-avatar-image"
              />
              <div className="user-name-container">
                <h1 className="user-name">
                  {currentSelectedUserData.patient_name}
                </h1>
            ...
            <div
              className="toggle-info-data-section"
              onClick={() => toggleUserInfoDetailsSection()}
            >
              {userDetailsSection === true ? (
                <BsChevronCompactDown size="20px" color="#4939E3" />
              ) : (
                <BsChevronCompactUp size="20px" color="#4939E3" />
              )}
            </div>
